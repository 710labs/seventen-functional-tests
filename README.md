...
- The standard workflow always runs the CA load flow, uses Pickup fulfillment, adds products to cart (default `1` per virtual user via the `cart_item_count` input, range 1–10), and stops after add-to-cart.
